...
The proposed HTTP mapping is [api-contract.md](../api-contract.md) Draft 0.1. Its page-to-API matrix and domain DTOs guide client implementation after review. Do not treat the present no-argument demo service methods or fixture IDs as a production contract.
