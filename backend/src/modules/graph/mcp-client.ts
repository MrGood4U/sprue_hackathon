...
export interface GraphMcpPlanningWire {
  ...
  callTool(tool: GraphMcpPlanningTool, args: Readonly<Record<string, unknown>>, signal?: AbortSignal): Promise<GraphMcpWireResult>;
  close(): Promise<void>;
}
...
function extractText(tool: GraphMcpPlanningTool, result: GraphMcpWireResult, maxBytes: number): string {
...
function parseJson(tool: GraphMcpPlanningTool, text: string): unknown {
  try {
...
export class RestrictedGraphMcpClient implements GraphPlanningMcpPort {
