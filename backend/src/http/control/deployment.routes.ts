...
export const deploymentRoutes: readonly RouteDefinition[] = [
  ...
  {
    method: "GET",
    path: "/api/v1/workspaces/{workspaceId}/products/{productId}/private-export",
    operationId: "getApiV1WorkspacesWorkspaceIdProductsProductIdPrivateExport",
    audience: "creator",
    implementation: "deployment-private-export",
    idempotency: false,
    ifMatch: false,
  },
  {
    ...
    audience: "creator",
    implementation: "deployments-create",
    idempotency: true,
    ifMatch: false,
  },
  {
